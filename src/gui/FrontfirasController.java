 ...
 * @author houss
 */
public class FrontfirasController implements Initializable {
    ...
    @FXML
    private Button btnAfficherEquipe;
    ...
    public void fnEqShow(){
        EquipeService sr=new EquipeService();
         ObservableList<Equipe> list = FXCollections.observableArrayList(sr.ShowByComp(Integer.parseInt(lbIdComp.getText())));;
    ...
    private void fnMenuCompetition(ActionEvent event) {
        ...
        btnAfficherEquipe.setVisible(false);
        btnAjouterEquipe.setVisible(false);
    }
    ...
    private void fnSelectedCompetition(MouseEvent event) {
        ...
        btnAfficherEquipe.setVisible(true);
        btnAjouterEquipe.setVisible(true);
    }
    ...
    private void fnConfEq(ActionEvent event) {
        ...
        if(lbTitleAjoutEquipe.isVisible()){
            ...
            c.setCompetition_id(Integer.parseInt(lbIdComp.getText()));
    ...
    @FXML
    private void fnAjouterEquipe(ActionEvent event) {
        pnFormEquipe.toFront();
        lbTitleAjoutEquipe.setVisible(true);
    }

    @FXML
    private void fnAfficherEquipe(ActionEvent event) {
        pnEquipe.toFront();
        fnEqShow();
    }
